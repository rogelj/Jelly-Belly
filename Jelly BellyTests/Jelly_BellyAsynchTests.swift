...
//            struct FakeDataTestMaker: DataTaskMaker {
...
//                    )
//
//                    return URLSession(configuration: .default).dataTask(with: Self.dummyURL)
//                }
//            }
//
//            _ = DogPatchClient(
//                baseURL: FakeDataTestMaker.dummyURL,
//                session: try FakeDataTestMaker(), responseQueue: nil
