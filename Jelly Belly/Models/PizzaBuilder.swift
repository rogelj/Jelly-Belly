...
public class JBPizzaBuilder {
    ...
    func build() -> Dish {
        ...
        return  Dish(name: name, ingredients: ingredients, cuisine: DishParts.cuisine[0], mealCategory: DishParts.MealCategory.miscellaneous, cost: cost, description: name)
    }
}
